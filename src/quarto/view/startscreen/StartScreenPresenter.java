...
import quarto.view.mainscreen.QuartoPresenter;
import quarto.view.mainscreen.QuartoView;
import javafx.event.*;
    ...
    private void EventHandlers() {
        view.getTransition().setOnFinished(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                QuartoView msView = new QuartoView(uiSettings);
                QuartoPresenter msPresenter = new QuartoPresenter(model, msView, uiSettings);
